...
const Card = ({data}:any)=>{
    ...
    return <>
        <Link href={`/product/${data.slug}`} onMouseEnter={() => setDescShow(true)} onMouseLeave={() => setDescShow(false)} className="card  w-full  lg:w-1/3 xl:w-1/4 p-4 overflow-hidden rounded-xl ">
